...
def search(query: str, paths: list, frecency: dict = None) -> list:
    ...
    # Optimized: Using a structured tuple (score, -length, p) allows using native
    # C-optimized sorting and heapq.nlargest without the overhead of key=lambda functions.
