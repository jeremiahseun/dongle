...
> **Prefer pip?** `pip install dongle` then add `eval "$(dongle init zsh)"` (or bash/fish) to your shell config.
...
```bash
export DONGLE_WORKSPACES="~/Documents/GitHub,~/Projects"
```
